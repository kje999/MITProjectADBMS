...
Public Class frmMyLuckyLotto
    ...
    Private Sub CheckforAvailableMessage()
        ...
        With cmd
            .Connection = con
            .CommandText = "SELECT MessageStatus from tblluckypick inner join tblwinner on tblluckypick.luckypickid=tblwinner.luckypickwinnerid where LPUsername='" & frmLogin.txtusername.Text & "'"
        End With
